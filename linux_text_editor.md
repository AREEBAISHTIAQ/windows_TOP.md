...
### Atom
**Atom** is free and open source text and source code editor  
...
if you want to install [sublime text](https://www.sublimetext.com/docs/3/linux_repositories.html) or [Atom](https://flight-manual.atom.io/getting-started/sections/installing-atom/#platform-linux) you can easily install them.but We recommend you to install **Visual Studio Code** because of its compatibility,speed, great support. you can install VSCode from [here](https://code.visualstudio.com/docs/setup/linux)
